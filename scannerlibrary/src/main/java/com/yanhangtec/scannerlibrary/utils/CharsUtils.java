package com.yanhangtec.scannerlibrary.utils;
...
public class CharsUtils {
    ...
    public static String byte2HexStrNoEmpty(byte[] b){
        String stmp;
        StringBuilder sb = new StringBuilder();
        for (byte value : b) {
            stmp = Integer.toHexString(value & 0xFF);
    ...
    public static String byte2Str(byte[] b) {
        return hexStr2Str(byte2HexStrNoEmpty(b));
    }
    ...
    public static byte XOR(byte[] bb){
